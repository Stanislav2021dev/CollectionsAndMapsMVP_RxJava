...
@LargeTest
public class EspressoTestCollections {
    ...
    private FragmentScenario<CollectionsFragment> scenario;

    @Before
    public void setMapsCollectionsFragment(){
        scenario = FragmentScenario.launchInContainer(CollectionsFragment.class);
